...
public class RoleController {
	...
	//@RequestMapping(value="roles",method=RequestMethod.GET) //localhost:8080/roles
	@GetMapping("roles")
	...
	@PostMapping("roles") //localhost:8080/roles method:post => les données sont retrouvées dans le body de la requête http
